...
var _user$project$Model$Team = F3(
	function (a, b, c) {
		return {name: a, overallKg: b, recentlyKg: c};
	});
var _user$project$Model$Model = F6(
	function (a, b, c, d, e, f) {
		return {input: a, messages: b, wsAddress: c, lift: d, snackbar: e, mdl: f};
	});
var _user$project$Model$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$Model$Snackbar = function (a) {
	return {ctor: 'Snackbar', _0: a};
};
var _user$project$Model$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Model$LiftClicked = {ctor: 'LiftClicked'};
var _user$project$Model$KgChange = function (a) {
	return {ctor: 'KgChange', _0: a};
};
var _user$project$Model$Loc = function (a) {
	return {ctor: 'Loc', _0: a};
};
var _user$project$Model$NewMessage = function (a) {
	return {ctor: 'NewMessage', _0: a};
};
var _user$project$Model$Send = {ctor: 'Send'};
var _user$project$Model$Input = function (a) {
	return {ctor: 'Input', _0: a};
};

var _user$project$PenkitView$viewMessage = function (msg) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$PenkitView$liftToText = function (lift) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'NOSTA ',
		A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(
				_elm_lang$core$Basics$truncate(lift)),
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Native_Utils.eq(
					lift,
...
var _user$project$PenkitView$toAddedKg = function (kg) {
	return {
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: A2(_debois$elm_mdl$Material_Options$css, 'font-weight', 'bolder'),
				_1: {
					ctor: '::',
			...
			},
			{
				...
				_0: _elm_lang$html$Html$text(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'+',
						_elm_lang$core$Basics$toString(kg))),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	};
};
var _user$project$PenkitView$toKg = function (kg) {
	return {
		ctor: '::',
		_0: _elm_lang$html$Html$text(
			_elm_lang$core$Basics$toString(kg)),
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('kg'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		}
...
var _user$project$PenkitView$team = function (team) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				_debois$elm_mdl$Material_Options$div,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A2(_debois$elm_mdl$Material_Options$css, 'width', '22rem'),
							_1: {
								ctor: '::',
								_0: A2(_debois$elm_mdl$Material_Options$css, 'margin-right', '2rem'),
								_1: {ctor: '[]'}
							}
						}
					}
			...
			_1: {
				...
				_0: A2(
					...
					_user$project$PenkitView$toKg(team.overallKg)),
				_1: {
					ctor: '::',
					_0: A2(
						_debois$elm_mdl$Material_List$content2,
						{ctor: '[]'},
						_user$project$PenkitView$toAddedKg(team.recentlyKg)),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$PenkitView$teams = {
	ctor: '::',
	_0: {name: 'TIIMI1', overallKg: 14005, recentlyKg: 640},
	_1: {
		ctor: '::',
		_0: {name: 'TIIMI2', overallKg: 7505, recentlyKg: 34},
		_1: {
			ctor: '::',
			_0: {name: 'TIIMI3', overallKg: 355, recentlyKg: 0},
			_1: {ctor: '[]'}
		}
	}
};
var _user$project$PenkitView$status = A2(
	...
	A2(_elm_lang$core$List$map, _user$project$PenkitView$team, _user$project$PenkitView$teams));
var _user$project$PenkitView$view = function (model) {
		...
		A2(
			...
			},
			{
				...
				_0: A3(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('PENKIT'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A5(
						...
						{
							ctor: '::',
							_0: _debois$elm_mdl$Material_Textfield$label('NIMI!'),
							_1: {
								ctor: '::',
						...
						_1: {
							...
							_1: {
								...
								_0: A5(
									...
									{
										ctor: '::',
										_0: _debois$elm_mdl$Material_Textfield$label('TIIMI!'),
										_1: {
											ctor: '::',
											_0: _debois$elm_mdl$Material_Textfield$floatingLabel,
											_1: {
												...
												_0: A2(
													...
													},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('RAUTAA KG!'),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
															_0: _debois$elm_mdl$Material_Slider$view(
																{
																	ctor: '::',
																	_0: _debois$elm_mdl$Material_Slider$onChange(_user$project$Model$KgChange),
																	_1: {
																		ctor: '::',
																		_0: _debois$elm_mdl$Material_Slider$value(model.lift),
																		_1: {
																			ctor: '::',
																			_0: _debois$elm_mdl$Material_Slider$min(20),
																			_1: {
																				ctor: '::',
																				_0: _debois$elm_mdl$Material_Slider$max(140),
																				_1: {
																					ctor: '::',
																					_0: _debois$elm_mdl$Material_Slider$step(2.5),
																					_1: {ctor: '[]'}
																				}
																			}
																		}
																...
																_1: {
																	...
																	_0: A5(
																		...
																		model.mdl,
																		{
																			...
																			_1: {
																				...
																				_1: {
																					...
																					_1: {
																						ctor: '::',
																						_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Model$LiftClicked),
																						_1: {
																							ctor: '::',
																		...
																		},
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text(
																				_user$project$PenkitView$liftToText(model.lift)),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
																		_0: _user$project$PenkitView$status,
																		_1: {ctor: '[]'}
																	}
																}
															}
...
var _user$project$Penkit$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _user$project$Model$Tick),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$websocket$WebSocket$listen, model.wsAddress, _user$project$Model$NewMessage),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Penkit$combineAddress = function (hostname) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'ws://',
		A2(_elm_lang$core$Basics_ops['++'], hostname, ':4567/chat'));
};
var _user$project$Penkit$init = function (location) {
	return {
		ctor: '_Tuple2',
		_0: A6(
			...
			'',
			{ctor: '[]'},
			_user$project$Penkit$combineAddress(location.hostname),
			80,
...
var _user$project$Penkit$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Input':
			...
			case 'Tick':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'LiftClicked':
				var c = A2(_debois$elm_mdl$Material_Snackbar$toast, 'ABC', 'DEF');
				var _p1 = A2(
					_debois$elm_mdl$Material_Helpers$map2nd,
					_elm_lang$core$Platform_Cmd$map(_user$project$Model$Snackbar),
					A2(_debois$elm_mdl$Material_Snackbar$add, c, _debois$elm_mdl$Material_Snackbar$model));
				var snackbar_ = _p1._0;
				var effect = _p1._1;
				return {ctor: '_Tuple2', _0: model, _1: effect};
			case 'Send':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_elm_lang$websocket$WebSocket$send, model.wsAddress, model.input)
				};
			case 'NewMessage':
				return {
					ctor: '_Tuple2',
			...
			case 'Loc':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							wsAddress: _user$project$Penkit$combineAddress(_p0._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Snackbar':
				var l = _elm_lang$core$Debug$log('sdfre');
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			default:
				return A3(_debois$elm_mdl$Material$update, _user$project$Model$Mdl, _p0._0, model);
		}
	});
var _user$project$Penkit$locParser = function (location) {
	return _user$project$Model$Loc(location.hostname);
};
var _user$project$Penkit$main = A2(
	_elm_lang$navigation$Navigation$program,
	_user$project$Penkit$locParser,
	{init: _user$project$Penkit$init, view: _user$project$PenkitView$view, update: _user$project$Penkit$update, subscriptions: _user$project$Penkit$subscriptions})();

var Elm = {};
Elm['Penkit'] = Elm['Penkit'] || {};
if (typeof _user$project$Penkit$main !== 'undefined') {
    _user$project$Penkit$main(Elm['Penkit'], 'Penkit', undefined);
}
